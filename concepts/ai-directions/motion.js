...
const variants={
 bottleneck:{edition:'01 / The bottleneck',kicker:'Get the routine jobs moving.',title:'Less waiting.<br><em>More doing.</em>',copy:'Enquiries in the right place. Reports ready to check. We set up the routine steps, so your team can get on with the work.',opening:'Everything waiting on the same step.<br><span>Open a better way through.</span>',hint:'Scroll to clear the bottleneck ↓',description:'A backlog queues at a closed manual gate. AI opens the mechanism and routes the work into three organised lanes.'},
 dashboard:{edition:'02 / Living dashboard',kicker:'Know where things stand.',title:'All the detail.<br><em>One clear picture.</em>',copy:'Your figures, together at last. We connect the information behind your business and prepare a summary you can check and use.',opening:'Different figures. Different places.<br><span>Bring the picture together.</span>',hint:'Scroll to reveal the bigger picture ↓',description:'Separate dimensional charts and loose data records assemble into one polished business dashboard with an AI summary.'}
};
